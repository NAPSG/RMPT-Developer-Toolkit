...
define([
  ...
  function(declare, BaseWidget, Directions, Locator, RouteParameters, esriRequest, graphicsUtils, LayerInfos,/*FeatureLayer, */queryUtil,/* FeatureSet,*/
        ...
        if (queryUtil.havePresetBarrierLayers(this.config)) {
          ...
          this.own(on(this.layerInfosObj, 'layerInfosFilterChanged', lang.hitch(this, function (/*layers*/) {
            if(true === this._updateBarriersFlag){
              this._queryAndUpdateBarriersFeatureSet();//TODO flit barrierLayers
            }
          })));
