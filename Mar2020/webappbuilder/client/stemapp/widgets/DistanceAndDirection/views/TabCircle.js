...
define([
  ...
  return dojoDeclare([dijitWidgetBase, dijitTemplatedMixin, dijitWidgetsInTemplate], {
    ...
    creationTypeDidChange: function () {
      var currentCreateCircleFrom = (this.creationType.get('value') === "Diameter") ? this.nls.diameterLabel : this.nls.radiusLabel;
    ...
    setGraphic: function (isManual, lineGeom) {
      ...
      centerPoint = (this.map.spatialReference.wkid === 4326) ?
        results.geometry : EsriWMUtils.geographicToWebMercator(results.geometry);
