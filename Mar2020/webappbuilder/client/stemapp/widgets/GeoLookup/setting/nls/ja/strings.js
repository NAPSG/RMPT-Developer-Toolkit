define({
  ...
  "fieldTable": {
    ...
    "colAlias": "エイリアス",
    "colOrder": "アクション",
    "label": "追加するフィールドのチェックボックスをオンにします。フィールドを選択して、エイリアスの更新および並べ替えを行います。"
  },
  "symbolArea": {
    "symbolLabelWithin": "範囲内の位置のシンボルを選択:",
    "symbolLabelOutside": "範囲外の位置のシンボルを選択:"
  },
  "advSettings": {
    "label": "高度な設定",
    ...
    "geometryServiceDesc": "再投影ポイントのジオメトリ サービス URL"
  },
