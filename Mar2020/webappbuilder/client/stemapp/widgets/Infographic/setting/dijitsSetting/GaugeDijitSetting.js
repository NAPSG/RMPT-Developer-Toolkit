...
define([
  ...
  function(declare, _WidgetsInTemplateMixin, lang, html, Color, on, BaseDijitSetting,
    ...
    var clazz = declare([BaseDijitSetting, _WidgetsInTemplateMixin], {
      ...
      setLayerDefinition: function(definition, rangeDefinition1, rangeDefinition2) {
        if (definition) {
        ...
        if (this.range1 && rangeDefinition1) {
          rangeDefinition1 = utils.preProcessDefinition(rangeDefinition1);
          this.range1.setLayerDefinition(rangeDefinition1);
        }
        if (this.range2 && rangeDefinition2) {
          rangeDefinition2 = utils.preProcessDefinition(rangeDefinition2);
          this.range2.setLayerDefinition(rangeDefinition2);
        }
      },
