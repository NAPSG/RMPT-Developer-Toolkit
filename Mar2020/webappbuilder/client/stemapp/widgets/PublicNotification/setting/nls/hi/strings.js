...
define({
  ...
  "querySourceSetting": {
    ...
    "instruction": "जियोकोड सेवाओं या सुविधाओं को सुविधा लेयर्स या खोज स्रोतों के रूप में जोड़ें और कॉन्फ़िगर करें। ये निर्दिष्ट स्रोत निर्धारित करते हैं कि खोज बॉक्स में क्या खोजा जा सकता है।",
    ...
    "locateResults": "परिणाम खोजें",
    "panTo": "इस पर पैन करें",
    "zoomToScale": "स्केल तक ज़ूम करें",
    "locatorError": "लोकेटर को एकल रेखा ढूंढने का समर्थन करना चाहिए।"
  }
});