...
define({
  ...
  "analysisTab": {
    ...
    "drawToolSelectableLayersLabel": "Выбрать доступные для выборки инструментом Рисование слои",
    "drawToolSelectableLayersHint": "Подсказка: Выбрать слои, доступные для выборки с помощью инструмента Рисование"
  },
  "downloadTab": {
