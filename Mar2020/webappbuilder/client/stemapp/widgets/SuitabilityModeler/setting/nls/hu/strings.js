define({
  "allowSaveAs": "Exportálás engedélyezése",
  "startingState": "Kezdeti állapot:",
  "byUrl": "Üres modell",
  "byItem": "Előre konfigurált modell",
  "imageServiceUrl": "Raszteres adatszolgáltatás URL-címe",
  "validate": "Érvényesítés",
  "validating": "Érvényesítés...",
  "validated": "Az URL érvényes.",
  "modelName": "Modell",
  "selectModel": "Kiválasztás",
  "itemSelectorTitle": "Válasszon egy modellt",
  "ok": "OK",
  "cancel": "Mégse",
  "description1": "A Suitability Modeler segít megtalálni a tevékenységéhez legalkalmasabb helyet, előre jelezni a kockázatoknak való kitettséget, vagy megállapítani, hol lehet számítani adott eseményekre. Ez a widget lehetővé teszi a különböző rétegek kombinálását és súlyozását, így egyszerre több tényezőt is ki lehet értékelni.",
  ...
  "description3": "Tudjon meg többet a GeoPlanner alkalmasságmodellezőről."
});