...
define([
  ...
  return dojoDeclare([dijitWidgetBase, dijitTemplatedMixin, dijitWidgetsInTemplate], {
    ...
    prefixChecked: false,
    _setPrefixCheckedAttr: function (v) {
      this.addSignChkBox.setValue(v);
    },
    ...
    postCreate: function () {
      ...
      this.own(dojoOn(this.frmtSelect, "change", dojoLang.hitch(this, this.frmtSelectValueDidChange)));
    ...
    formatValDidChange: function () {
      ...
      var crdType = this.frmtSelect.value;
    ...
    frmtSelectValueDidChange: function () {
      var curval = this.frmtSelect.value;
