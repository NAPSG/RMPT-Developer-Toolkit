    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      postCreate: function () {
        ...
        this.lineOpacity.onChange = lang.hitch(this, function (val) {
          this.lineOpacityVal.innerHTML = (!window.isRTL) ? Math.round(val * 100) + '%' : '%' + Math.round(val * 100);
          grid.setLineOpacity(val);
        });
        this.labelOpacity.onChange = lang.hitch(this, function (val) {
          this.labelOpacityVal.innerHTML = (!window.isRTL) ? Math.round(val * 100) + '%' : '%' + Math.round(val * 100);
      ...
      setConfig: function () {
        ...
        this.minIntervalSpacingVal.innerHTML = (!window.isRTL) ? this.config.minIntervalSpacing + 'px' :
          'px' + this.config.minIntervalSpacing;
        this.lineOpacity.set('value', this.config.lineOpacity);
        this.lineOpacityVal.innerHTML = (!window.isRTL) ? Math.round(this.config.lineOpacity * 100) + '%' :
          '%' + Math.round(this.config.lineOpacity * 100);
        this.labelOpacity.set('value', this.config.labelOpacity);
        this.labelOpacityVal.innerHTML = (!window.isRTL) ? Math.round(this.config.labelOpacity * 100) + '%' :
          '%' + Math.round(this.config.labelOpacity * 100);
