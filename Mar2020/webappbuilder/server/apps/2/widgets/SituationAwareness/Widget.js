    ...
    function (declare, _WidgetsInTemplateMixin, Button,
        ...
        return declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            onOpen: function () {
                ...
                if (typeof (this.config.themeLabel) !== 'undefined') {
                    if (typeof (this.incidentTheme) == 'object') {
                        //alert(typeof (this.incidentTheme));
                        this.incidentTheme.set("value", this.config.themeLabel ? this.config.themeLabel : "Lifeline");
                        // alert(this.incidentTheme);
                        //this.incidentTheme = this.config.themeLabel;
                    }
                   // this.incidentTheme.set("value", this.config.themeLabel ? this.config.themeLabel : "Lifeline");
                }
            },
