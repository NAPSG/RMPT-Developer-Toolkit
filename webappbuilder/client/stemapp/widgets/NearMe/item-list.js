...
define([
  ...
  return declare([_WidgetBase, Evented], {
    ...
    postCreate: function () {
      ...
      this._gallerySwiper = null; //to store the gallery swiper dijit
    ...
    **/
    resetGallery: function () {
      if (this._gallerySwiper) {
        this._gallerySwiper.update();
        this._gallerySwiper.slideReset();
      }
    },
      ...
      if (infos && infos.length > 0 ||
        ...
        this._checkMediaInfos(swiperWrapper, popupRenderer).then(
          lang.hitch(this, function (hasMediaInfos) {
            ...
            this._gallerySwiper = gallerySwiper;
          }));
      } else {
        this._gallerySwiper = null;
      }
    },
