   ...
   **/
      ...
      switch (chartType) {
        ...
        case "LineChart":
          if (this.lineChartValueFieldsTextbox.value !== "" &&
            ...
            chartData.chartSeries.push([
              { "y": 45, tooltip: "45&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 43, tooltip: "43&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 15, tooltip: "15&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 26, tooltip: "26&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 38, tooltip: "38&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 10, tooltip: "10&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 47, tooltip: "47&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 19, tooltip: "19&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 47, tooltip: "47&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 23, tooltip: "23&nbsp;&nbsp;&nbsp;&nbsp" }
            ]);
            chartData.chartSeries.push([
              { "y": 93, tooltip: "93&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 98, tooltip: "98&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 41, tooltip: "41&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 81, tooltip: "81&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 94, tooltip: "94&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 98, tooltip: "98&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 99, tooltip: "99&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 44, tooltip: "44&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 58, tooltip: "58&nbsp;&nbsp;&nbsp;&nbsp" },
              { "y": 73, tooltip: "73&nbsp;&nbsp;&nbsp;&nbsp" }
            ]);
          }
    ...
    **/
    ...
    _onFieldsSelectorClick: function () {
      var lineChartValueFieldsArray = [], contentDom, layerFields;
    ...
    **/
    _getValueFieldsByValue: function (lineChartValueFieldsInput) {
      var valueFieldsValueArr = [], layerFields, lineChartValueFields = [];
    ...
    **/
    _setCofigDataSeriesValueForline: function (configValueFields) {
      var configValueFieldsArr = [], layerFields, lineChartValueFields = [];
