...
define({
  ...
  "analysisTab": {
    ...
    "drawToolSelectableLayersLabel": "حدد الطبقات القابلة للتحديد لأداة الرسم",
    "drawToolSelectableLayersHint": "ملاحظة: حدد الطبقات التي ستكون متاحة للتحديد في قائمة طبقة أداة الرسم"
  },
  "downloadTab": {
