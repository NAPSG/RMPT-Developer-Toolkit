...
define({
  ...
  "analysisTab": {
    ...
    "drawToolSelectableLayersLabel": "בחר שכבות הניתנות לבחירה בכלי הציור",
    "drawToolSelectableLayersHint": "רמז: בחר שכבות שיהיו זמינות לבחירה ברשימת השכבות של כלי הציור"
  },
  "downloadTab": {
