...
define({
  root: ({
    ...
    analysisTab: {
      ...
      drawToolSelectableLayersLabel: "Select draw tool selectable layers",
      drawToolSelectableLayersHint: "Hint: Select layers that will be available for selection in draw tool layer list"
    },
    downloadTab: {
