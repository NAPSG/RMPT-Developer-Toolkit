    ...
    return declare([BaseWidget, dijitWidgetBase, dijitWidgetsInTemplate], {
      ...
      postCreate: function () {
        ...
        if (this.ThreatArea.loaded) {
          // show or hide labels
          featureLayerInfo =
            jimuLayerInfos.getInstanceSync().getLayerInfoById("Threat-Graphic");
      ...
      _initListeners: function () {
        ...
        this.own(on(this.threatCoordinateControl.coordtext, 'keyup', lang.hitch(this, function () {
          this._toggleCreateZoneButton(false);
        })));
      ...
      _showThreatLocationTooltip: function () {
        this.own(on.once(this.threatCoordinateControl.coordtext, dojoMouse.enter, lang.hitch(this, function () {
          dijitTooltip.show("Manually input coordinates and click <b>Enter</b> to zoom to it",
            this.threatCoordinateControl.coordtext);
        })));
      ...
      _threatCreateButtonClicked: function () {
        this._createThreatAreas(this._currentGeometry, this._selectedThreat, this._selectedUnitType);
      },
      ...
      _createThreatAreas: function (geom, selectedThreat, unitType) {
        if (geom && selectedThreat) {
          ...
          var safeGeom = GeometryEngine.geodesicBuffer(threatLocation, selectedThreat.safeDistance, geodesicNum);
